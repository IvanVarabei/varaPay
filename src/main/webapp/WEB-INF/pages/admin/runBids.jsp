			...
			<c:forEach var="bid" items="${bids}">
				<div class="run-bids__row">
					...
					<form class="run-bids__form run-bids__item" method="post">
						...
						<button class="button"
										formaction="${pageContext.servletContext.contextPath}/mainServlet?command=reject_bid_post&page=
						...
						<button class="button"
										formaction="${pageContext.servletContext.contextPath}/mainServlet?command=approve_bid_post&page=
										${requestScope.currentPage eq requestScope.amountOfPages ?
										 (bids.size() > 1 ? requestScope.currentPage : requestScope.currentPage-1)
										 : requestScope.currentPage}">
								${approve}
