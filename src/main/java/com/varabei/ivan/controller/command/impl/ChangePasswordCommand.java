...
public class ChangePasswordCommand implements ActionCommand {
    ...
    public Router execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        changePasswordData.put(UserField.PASSWORD, req.getParameter(UserField.PASSWORD));
        changePasswordData.put(RequestParam.REPEAT_PASSWORD, req.getParameter(RequestParam.REPEAT_PASSWORD));
        changePasswordData.put(UserField.LOGIN, req.getSession().getAttribute(UserField.LOGIN).toString());
        try {
